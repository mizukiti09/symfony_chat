 ...
 */
final class Version20210921150647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_B6BD307F2130303A');
        $this->addSql('DROP INDEX UNIQ_B6BD307F29F6EE60');
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, to_user_id, from_user_id, created_at, updated_at, delete_flg FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, to_user_id INTEGER DEFAULT NULL, from_user_id INTEGER DEFAULT NULL, created_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , updated_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , delete_flg BOOLEAN DEFAULT NULL, message VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_B6BD307F29F6EE60 FOREIGN KEY (to_user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F2130303A FOREIGN KEY (from_user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO message (id, to_user_id, from_user_id, created_at, updated_at, delete_flg) SELECT id, to_user_id, from_user_id, created_at, updated_at, delete_flg FROM __temp__message');
        $this->addSql('DROP TABLE __temp__message');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B6BD307F2130303A ON message (from_user_id)');
